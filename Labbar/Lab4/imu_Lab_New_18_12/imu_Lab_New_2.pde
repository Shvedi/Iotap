...
boolean trainFile = false; // if trainFile is set to True, the application generates training dataset
boolean logFile = false; // logs sensordata
boolean gesture_rec = true; // recognizes gestures in real-time
long stamp = 0;
