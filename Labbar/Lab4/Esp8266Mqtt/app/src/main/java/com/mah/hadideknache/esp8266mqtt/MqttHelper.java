...
public class MqttHelper {
    ...
    private String serverUri = "Write server adress tcp://+server:port";
    private String mqttUser = "Username goes here";
    private String mqttPassword = "Password goes here";
    ...
    /**
     * Method used for RGB ONLY! when clicking on the button
     */
        ...
        colorPick.setCallback(new ColorPickerCallback() {
            ...
            public void onColorChosen(@ColorInt int color) {
                ...
                try {
                    ...
                    activity.setColor(String.format("#%08X", (color)));
                } catch (MqttException e) {
                    e.printStackTrace();
                }
                colorPick.cancel();
    ...
    /**
     * Method is used when turning led on/off
     */
